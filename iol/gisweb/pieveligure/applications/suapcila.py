...
from iol.gisweb.pieveligure.interfaces import IIolApp,IIolPraticaWeb
...
class suapcilaApp(object):
    ...
    def NuovoNumeroPratica(self,obj):
        ...
        query = dict(IOL_NUM_FIELD = dict(query=0, range='min'), iol_tipo_app = 'suapcila')
